...
<html lang="en">
  <head>
    ...
    <title>Admin Sportpreneur</title>
    <!-- plugins:css -->
    <link rel="stylesheet" href="<?= $url_admin ?>assets/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="<?= $url_admin ?>assets/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?=$url_admin?>assets/css/style.css">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="<?=$url_admin?>assets/images/favicon.ico" />
  </head>
  <body>
